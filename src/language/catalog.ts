...
import {
    ...
    aggOf, fun, groupOf, jkindType, listOf, nullable, prim, queryOf, rowOf,
} from './types.js';
...
export const BUILTIN_SPECS: BuiltinSpec[] = [
    ...
    { name: 'date_add', category: 'date', doc: 'date_add x "day" 1', scheme: u => poly(u, [tVar], t => fun(nullable(t), fun(p('string'), fun(p('int'), nullable(t))))) },
    { name: 'date_diff', category: 'date', doc: 'date_diff x "day" other', scheme: u => poly(u, [tVar], t => fun(nullable(t), fun(p('string'), fun(nullable(t), p('int'))))) },
    ...
    { name: 'lag', category: 'window', doc: 'lag [x, offset?, default?] — window-only', scheme: u => poly(u, [tVar], t => fun(listOf(nullable(t)), nullable(t))) },
    ...
    { name: 'ntile', category: 'window', doc: 'NTILE — window-only', scheme: () => mono(fun(nullable(p('int')), p('int'))) },
];
